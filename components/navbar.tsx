...
import { GithubIcon, KeyboardIcon } from "lucide-react";
...
export function Logo() {
  return (
    <LocalizedLink href="/" className="flex items-center gap-2.5">
      <KeyboardIcon className="w-6 h-6 text-muted-foreground" strokeWidth={2} />
      <h2 className="text-md font-bold font-code">concepteur-developpeur</h2>
    </LocalizedLink>
  );
}
